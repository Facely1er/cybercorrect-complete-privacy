  ...
  const journeySteps = [
    {
      ...
      duration: '2-3 weeks',
      tools: [
        { name: 'Data Classification Assessment', path: '/toolkit/data-classification', icon: Database },
        { name: 'GDPR Data Mapper', path: '/toolkit/gdpr-mapper', icon: Database },
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block mb-6">
              <span className="bg-success/10 text-success dark:bg-dark-primary/10 dark:text-primary px-4 py-2 rounded-full inline-flex items-center text-sm font-medium">
        ...
        <section className="py-8 bg-gradient-to-r from-success/5 via-secondary/5 to-success/5 border-b border-border">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <Card className="border-2 border-success/20 bg-white/80 dark:bg-background/80 backdrop-blur">
