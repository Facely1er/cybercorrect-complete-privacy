...
async function exportDataRightsRequestsCSV(data: DataRightsRequest[], filename: string) {
...
async function exportPrivacyIncidentsCSV(data: PrivacyIncident[], filename: string) {
...
async function exportVendorAssessmentsCSV(data: VendorAssessment[], filename: string) {
...
async function exportConsentRecordsCSV(data: ConsentRecord[], filename: string) {
...
async function exportComplianceObligationsCSV(data: ComplianceObligation[], filename: string) {
...
function generateTextSummary(data: ExportData): string {
  const summary = [
    ...
    ...data.consentRecords.map(consent => 
      `${consent.employeeName} | ${consent.consentType} | ${consent.consentGiven ? 'Granted' : 'Not Granted'} | ${consent.status}`
    ),
    '',
