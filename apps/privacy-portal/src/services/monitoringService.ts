...
class MonitoringService {
      ...
      try {
        ...
        new PerformanceObserver((list) => {
          ...
          entries.forEach((entry: PerformanceEntry) => {
            ...
            this.trackPerformanceMetric('firstInputDelay', perfEntry.processingStart - perfEntry.startTime);
          });
        ...
        new PerformanceObserver((list) => {
          ...
          entries.forEach((entry: PerformanceEntry) => {
            ...
            if (!layoutEntry.hadRecentInput) {
              this.trackPerformanceMetric('cumulativeLayoutShift', layoutEntry.value);
            }
          });
  ...
  trackBusinessMetric(metric: string, value: number, context?: Record<string, unknown>): void {
    if (!environment.production || !appConfig.analytics.enabled) {
      return;
    }
