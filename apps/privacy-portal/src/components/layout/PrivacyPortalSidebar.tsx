      ...
      items: [
        {
          ...
          icon: Database,
          description: 'Map and visualize personal data assets',
          subItems: [
            { title: 'Data Assets', href: '/privacy/data-inventory?tab=assets', description: 'Manage data asset records' },
            { title: 'Data Flows', href: '/privacy/data-inventory?tab=flows', description: 'Track data movements' },
            { title: 'Data Mapping', href: '/privacy/data-inventory?tab=mapping', description: 'Visualize data relationships' },
            { title: 'Retention', href: '/privacy/data-inventory?tab=retention', description: 'Manage retention policies' }
          ]
        },
        {
          title: 'Privacy by Design',
          href: '/privacy/privacy-by-design',
          icon: Target,
          description: 'Evaluate privacy by design principles',
          subItems: [
            { title: 'Assessments', href: '/privacy/privacy-by-design?tab=assessments', description: 'View all assessments' },
            { title: 'Principles', href: '/privacy/privacy-by-design?tab=principles', description: 'Evaluate principles' },
            { title: 'Templates', href: '/privacy/privacy-by-design?tab=templates', description: 'Assessment templates' },
            { title: 'Guidance', href: '/privacy/privacy-by-design?tab=guidance', description: 'Implementation guidance' }
          ]
        },
        {
          ...
          subItems: [
            { title: 'All DPIAs', href: '/privacy/dpia?tab=assessments', description: 'View all DPIA assessments' },
            { title: 'Risk Analysis', href: '/privacy/dpia?tab=risks', description: 'Analyze privacy risks' },
            { title: 'Templates', href: '/privacy/dpia?tab=templates', description: 'DPIA templates' },
            { title: 'Guidance', href: '/privacy/dpia?tab=guidance', description: 'DPIA guidance' }
          ]
        },
        {
          title: 'Data Lawfulness',
          href: '/privacy/data-lawfulness',
          icon: Scale,
          description: 'Assess legal basis for processing',
          subItems: [
            { title: 'Assessments', href: '/privacy/data-lawfulness?tab=assessments', description: 'View all assessments' },
            { title: 'Legal Basis', href: '/privacy/data-lawfulness?tab=legal_basis', description: 'Legal basis framework' },
            { title: 'Templates', href: '/privacy/data-lawfulness?tab=templates', description: 'Assessment templates' },
            { title: 'Guidance', href: '/privacy/data-lawfulness?tab=guidance', description: 'Legal guidance' }
          ]
        },
        {
          title: 'Retention Policy',
          href: '/privacy/retention-policy',
          icon: Clock,
          description: 'Manage data retention policies',
          subItems: [
            { title: 'Policies', href: '/privacy/retention-policy?tab=policies', description: 'Manage retention policies' },
            { title: 'Data Records', href: '/privacy/retention-policy?tab=records', description: 'Track data records' },
            { title: 'Schedule', href: '/privacy/retention-policy?tab=schedule', description: 'Retention schedule' },
            { title: 'Compliance', href: '/privacy/retention-policy?tab=compliance', description: 'Compliance overview' }
          ]
        },
        {
          title: 'Industry Compliance',
          href: '/privacy/industry-compliance',
          icon: Building,
          description: 'Industry-specific regulations',
          subItems: [
            { title: 'Healthcare (HIPAA)', href: '/privacy/industry-compliance?tab=healthcare', description: 'HIPAA compliance' },
            { title: 'Financial (GLBA)', href: '/privacy/industry-compliance?tab=financial', description: 'GLBA compliance' },
            { title: 'Education (FERPA)', href: '/privacy/industry-compliance?tab=education', description: 'FERPA compliance' },
            { title: 'Other Industries', href: '/privacy/industry-compliance?tab=other', description: 'Other regulations' }
          ]
        },
        {
          title: 'Service Providers',
          href: '/privacy/service-providers',
          icon: Globe,
          description: 'Manage third-party agreements',
          subItems: [
            { title: 'All Providers', href: '/privacy/service-providers?tab=providers', description: 'View all providers' },
            { title: 'Agreements', href: '/privacy/service-providers?tab=agreements', description: 'Manage agreements' },
            { title: 'Compliance', href: '/privacy/service-providers?tab=compliance', description: 'Compliance status' },
            { title: 'Risk Assessment', href: '/privacy/service-providers?tab=risks', description: 'Risk assessments' }
          ]
        },
        {
          title: 'Sensitive Data',
          href: '/privacy/sensitive-data',
          icon: Lock,
          description: 'Handle sensitive personal information',
          subItems: [
            { title: 'Data Records', href: '/privacy/sensitive-data?tab=records', description: 'Manage sensitive data' },
            { title: 'Classification', href: '/privacy/sensitive-data?tab=classification', description: 'Data classification' },
            { title: 'Protection', href: '/privacy/sensitive-data?tab=protection', description: 'Protection measures' },
            { title: 'Incidents', href: '/privacy/sensitive-data?tab=incidents', description: 'Incident management' }
          ]
        }
      ]
    },
