      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <SecureFormField
            ...
            required
            helpText="Your relationship to the employee whose data is being requested"
          />
          ...
          <SecureFormField
            ...
            type="text"
            value={data.employeeIdentifier || ''}
            onChange={(value) => updateField('employeeIdentifier', value)}
            onBlur={() => validateField('employeeIdentifier', data.employeeIdentifier)}
            error={errors.employeeIdentifier}
            required
            placeholder="Employee ID, name, or other identifier"
            helpText="Employee ID number, full name, or other identifying information"
          />
        </div>
