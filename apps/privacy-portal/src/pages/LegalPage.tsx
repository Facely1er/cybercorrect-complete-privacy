...
import { FileText, Mail, Shield, Scale, Gavel, AlertTriangle, BookOpen } from 'lucide-react';
          ...
          <div className="bg-card rounded-lg border p-8 space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                The information provided on this platform is for general informational and compliance purposes only and does not constitute legal advice. {brand.legal.companyName} is not a law firm, and the content available on {brand.productNameWithTM} does not establish an attorney-client relationship.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  {brand.productNameWithTM} is designed to assist organizations with their privacy and data protection compliance efforts. However, the use of our platform does not guarantee compliance with any specific law or regulation, including but not limited to:
                </p>
            ...
            <section>
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-6 border border-amber-200 dark:border-amber-800">
                ...
                <ul className="list-disc pl-6 space-y-2 text-amber-700 dark:text-amber-400">
                  <li>Consult with legal counsel experienced in workplace privacy laws</li>
