...
export function HowItWorksPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Role-specific guidance and checklists for administrators, staff, and privacy officers on their privacy duties and compliance obligations.',
  ...
  const stakeholderJourneys = [
    ...
    },
    {
      ...
      outcome: 'Confident compliance with privacy duties'
    },
    {
      role: 'Administrators',
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-muted-foreground">
                Identify your role and understand your specific privacy rights and duties within the organization.
              </p>
              <div className="mt-4">
      ...
      <section className="w-full bg-primary-600 dark:bg-primary-700 py-16">
        <div className="container mx-auto px-4 text-white text-center">
          ...
          <p className="text-white/90 text-lg mb-8 max-w-3xl mx-auto">
            Join organizations worldwide that trust {brand.fullBrandName} to simplify compliance, protect employee data, and empower stakeholders to exercise their privacy rights.
          </p>
