              ...
              {privacyIncidents.slice(0, 3).map((incident) => (
                <div key={incident.id} className="border rounded-lg p-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-muted-foreground">
                        <div className="flex items-center gap-2">
                          ...
                          <span>{incident.affectedCount || incident.affectedIndividualsCount || 0} affected</span>
                        </div>
                        <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    {(incident.regulations || incident.applicableRegulations || []).map(reg => (
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {[
                    ...
                    'Health records', 'Performance data', 'Financial information', 'Biometric data',
              ...
              <div>
                ...
                <div className="mt-6 pt-4 border-t">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Link to="/how-it-works" title="Privacy incident response training">
                      <Button variant="outline" size="sm">
