  ...
  const permissionGroups = [
    {
      name: 'Data Access',
      permissions: [
        { id: 'view_employee_records', label: 'View Employee Records', count: 892 },
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg border p-6">
            ...
            <div className="space-y-4">
              {[
                ...
                { label: 'Employees', count: stakeholderStats.employees, color: 'bg-green-500' },
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg border p-6">
            ...
            <div className="mt-6 pt-4 border-t">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Link to="/faq" title="Security awareness training for stakeholders">
                  <Button variant="outline" size="sm">
