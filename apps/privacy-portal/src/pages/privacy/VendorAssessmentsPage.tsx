...
export function VendorAssessmentsPage() {
  ...
  const [vendorAssessments, setVendorAssessments] = useState<unknown[]>([]);
  const [loading, setLoading] = useState(true);

  // Load data when component mounts
  React.useEffect(() => {
    const loadVendorAssessments = async () => {
      try {
        setLoading(true);
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        {(vendor.dataTypesProcessed || []).map((dataType: string, index: number) => (
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        {(vendor.applicableRegulations || []).map((reg: string) => (
                    ...
                    {vendor.securityCertifications.length > 0 && (
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          {(vendor.securityCertifications || []).map((cert: string, index: number) => (
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg border p-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                { name: 'EEOC Assessment for Workplace Tech', regulations: ['EEOC'], description: 'Employment privacy assessment for workplace technology' },
        ...
        <TabsContent value="compliance" className="space-y-6">
                  ...
                  {['ferpa', 'coppa', 'ccpa', 'shield', 'bipa'].map((reg) => {
                    ...
                    return (
                      <div key={reg} className="space-y-2">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <Badge variant="info">{reg.toUpperCase()}</Badge>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Link to="/faq" title="Learn how to review vendor privacy policies">
                <Button variant="outline" className="justify-start w-full">
            ...
            <div className="mt-6 pt-4 border-t">
              ...
              <div className="flex flex-wrap gap-2">
                <Link to="/faq" title="Vendor management training modules">
                  <Button variant="outline" size="sm">
