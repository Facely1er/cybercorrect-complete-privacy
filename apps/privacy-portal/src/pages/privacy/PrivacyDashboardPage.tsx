...
export function PrivacyDashboardPage() {
  ...
  const [privacyIncidents, setPrivacyIncidents] = React.useState<unknown[]>([]);
  const [vendorAssessments, setVendorAssessments] = React.useState<unknown[]>([]);
  const [consentRecords, setConsentRecords] = React.useState<unknown[]>([]);
  const [complianceObligations, setComplianceObligations] = React.useState<unknown[]>([]);
  ...
  const recentActivity = [
    ...dataRightsRequests.slice(0, 2).map(req => ({
      ...
      description: `Request for ${req.employeeName || 'employee records'}`,
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Comprehensive privacy compliance management for your organization
        </p>
      </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg border p-6">
            ...
            <div className="mt-6 pt-4 border-t">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Link to="/how-it-works" title="Access privacy training modules">
                  <Button variant="outline" size="sm">
                    Training guides
                  </Button>
                </Link>
                <Link to="/faq" title="Download privacy policy templates and tools">
                  <Button variant="outline" size="sm">
                    Privacy resources
                  </Button>
                </Link>
