...
export function DataRightsPortalPage() {
  ...
  const [dataRightsRequests, setDataRightsRequests] = useState<unknown[]>([]);
  const [loading, setLoading] = useState(true);

  // Load data when component mounts or when returning from form
  React.useEffect(() => {
  ...
  const requestTypes = [
    {
      id: 'access',
      name: 'Access Request',
      description: 'Request to view or obtain copies of employment records',
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Loading data rights requests...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Submit and track requests related to employee and personal data rights under privacy regulations
        </p>
      </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {request.employeeName} • Submitted {request.submittedAt}
                      </p>
                    </div>
                  </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                  <li>Inspect and review employment records</li>
            ...
            <div className="mt-6 pt-4 border-t">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Link to="/how-it-works" title="Educational content about data rights">
                  <Button variant="outline" size="sm">
