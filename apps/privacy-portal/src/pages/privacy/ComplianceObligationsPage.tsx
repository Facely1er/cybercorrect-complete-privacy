...
export function ComplianceObligationsPage() {
  ...
  const [complianceObligations, setComplianceObligations] = useState<unknown[]>([]);
  const [loading, setLoading] = useState(true);

  // Load data when component mounts
  React.useEffect(() => {
    const loadComplianceObligations = async () => {
      try {
        setLoading(true);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Loading compliance obligations...</p>
          </div>
        </div>
      </div>
    );
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg border p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-2">
                ...
                <Link to="/privacy/obligations" title="View the full compliance calendar">
                  <Button variant="outline" size="sm">
            ...
            <div className="text-center p-8">
              ...
              <Link to="/privacy/obligations" title="Access the full compliance calendar">
                <Button>
