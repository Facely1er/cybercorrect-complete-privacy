  ...
  const faqData: FAQItem[] = [
    // General questions
    {
      ...
      answer: (
        <>
          <p>
            {brand.productNameWithTM} is a comprehensive workplace compliance platform designed to help employers and organizations
            navigate privacy regulations and protect employee data. Our platform offers:
          </p>
          ...
          <p className="mt-2">
            We focus on regulations such as ADA, EEOC, CCPA/CPRA, GDPR, and other privacy laws that impact employers and organizations.
          </p>
        </>
      ),
      category: 'general'
    },
    {
      ...
      answer: (
        <>
          <p>{brand.productNameWithTM} is designed for all stakeholders in workplace environments, including:</p>
          <ul className="list-disc ml-6 mt-2 space-y-1">
            <li><strong>Administrators:</strong> Organizational leaders responsible for compliance oversight</li>
            <li><strong>HR Staff:</strong> Human resources professionals who handle employee information</li>
            <li><strong>IT Staff:</strong> Technology personnel managing systems and data security</li>
            <li><strong>Employees:</strong> Workers who need to understand their privacy rights</li>
          </ul>
          <p className="mt-2">
    ...
    },
    {
      ...
      answer: (
        <>
          <p>
            {brand.productNameWithTM} offers flexible pricing models designed to accommodate organizations of all sizes:
          </p>
          <ul className="list-disc ml-6 mt-2 space-y-1">
    ...
    // Privacy questions
    {
      ...
      answer: (
        <>
          <p>{brand.productNameWithTM} implements robust data protection measures in line with workplace privacy requirements:</p>
          <ul className="list-disc ml-6 mt-2 space-y-1">
    ...
    {
      id: 'employee-data',
      question: `Does ${brand.productNameWithTM} store employee data?`,
      answer: (
        <p>
          {brand.productNameWithTM} primarily collects account information and assessment/training progress data. We do not require or store employee employment records unless specifically uploaded by authorized users as part of compliance documentation. Any employee data handled by our platform is subject to strict privacy controls and is only accessible to authorized users within your organization. Our platform is designed to help you manage compliance with privacy regulations, not to act as a repository for sensitive employee information.
        </p>
      ),
      category: 'privacy'
    },
    ...
    // Compliance questions
    {
      ...
      answer: (
        <>
          ...
          <p className="mt-2">
            Many organizations include these certificates in their compliance documentation to demonstrate due diligence in privacy protection efforts.
          </p>
        </>
      ),
      category: 'compliance'
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-muted-foreground">
              Find answers to common questions about {brand.productNameWithTM} and workplace privacy compliance
            </p>
          </div>
          <Button 
            variant="outline"
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border p-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Button 
            ...
            onClick={() => handleNavigation('/contact')}
            title="Contact our support team for personalized assistance"
          >
          ...
          <div className="mt-6 pt-4 border-t">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <Button 
                ...
                title={`Learn how ${brand.productNameWithTM} works`}
              >
              ...
              <Button 
                ...
                title="Access self-paced training modules"
              >
              ...
              <Button 
                ...
                title="Download helpful templates and guides"
              >
              ...
              <Button 
                ...
                title="Test your knowledge with our assessments"
              >
