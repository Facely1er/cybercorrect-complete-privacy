...
export function DataRightsExercisePage() {
  ...
  const loadDataRightsRequests = async () => {
    try {
      setIsLoading(true);
      setError(null);
  ...
  // Load data when component mounts or form closes
  useEffect(() => {
  ...
  const dataRights = [
    {
      ...
      description: 'Request to view or obtain copies of your employment data',
      icon: <Eye className="h-6 w-6" />,
      regulations: ['ADA', 'EEOC', 'CCPA', 'GDPR'],
      timeline: '30-45 days',
      examples: [
        'View your payroll and benefits records',
        'Get copies of performance reviews',
        'Access HR communication logs',
    ...
    },
    {
      ...
      timeline: '30-45 days',
      examples: [
        'Correct factual errors in employment records',
        'Update outdated contact information',
        'Fix performance review inaccuracies',
        'Amend misleading HR information'
      ],
      requirements: [
    ...
    },
    {
      ...
      description: 'Request deletion of employment information when legally permissible',
      icon: <Trash2 className="h-6 w-6" />,
      regulations: ['CCPA', 'GDPR', 'Employment Privacy Laws'],
      timeline: '30 days',
      examples: [
        'Delete unnecessary employment data',
        'Remove old application information',
        'Erase marketing preferences',
        'Delete obsolete HR records'
      ],
      requirements: [
        'Must not conflict with legal obligations',
        'Employment records may have retention requirements',
    ...
    },
    {
      ...
      description: 'Request your employment data in a portable, machine-readable format',
      icon: <Download className="h-6 w-6" />,
      regulations: ['GDPR', 'CCPA', 'Employment Privacy Laws'],
      timeline: '30 days',
      examples: [
        'Export performance analytics data',
        'Download work history records',
        'Get training and certification data',
        'Transfer data to new employer'
      ],
      requirements: [
    ...
    },
    {
      ...
      description: 'Opt-out of employment data sale, sharing, or marketing communications',
      icon: <Shield className="h-6 w-6" />,
      regulations: ['CCPA', 'CPRA', 'Employment Privacy Laws'],
      timeline: 'Immediate',
      examples: [
        'Stop data sharing with third parties',
        'Opt-out of marketing emails',
        'Disable targeted advertising',
        'Block employment data sales'
      ],
      requirements: [
    ...
    {
      id: 'workplace-opt-out',
      title: 'Workplace Directory Opt-Out',
      description: 'Prevent disclosure of workplace directory information',
      icon: <FileText className="h-6 w-6" />,
      regulations: ['Employment Privacy Laws', 'ADA'],
      timeline: 'Immediate',
      examples: [
        'Remove from company directories',
        'Block name from public announcements',
        'Prevent internal directory inclusion',
        'Stop workplace media mentions'
      ],
      requirements: [
        'Annual notification provided',
        'Reasonable time to opt-out',
        'Must specify information types',
        'Affects all workplace directory disclosures'
      ]
    }
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Exercise Your Workplace Data Privacy Rights</h1>
        <p className="text-muted-foreground">
          Submit requests to access, correct, delete, or transfer your employment data. Our self-service portal guides you through each type of request under ADA, EEOC, CCPA, GDPR, and other employment privacy regulations.
        </p>
      </div>
      ...
      <div className="bg-primary/5 rounded-lg border border-primary/20 p-6 mb-8">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2 text-foreground">Know Your Workplace Privacy Rights</h2>
            <p className="text-muted-foreground mb-4">
              As an employee, job applicant, or workplace stakeholder, you have specific rights regarding how personal and employment information is collected, used, and shared. These rights are protected by federal and state employment privacy laws and can be exercised through this portal.
            </p>
            <div className="flex flex-wrap gap-2 mb-4">
              <Badge variant="ferpa">ADA Protected</Badge>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg border p-6 mb-8">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8">
            ...
            <h3 className="font-medium mb-2 text-red-600">Error loading requests</h3>
            <p className="text-muted-foreground mb-4">{error}</p>
            <Button onClick={loadDataRightsRequests}>
              Try Again
            </Button>
          </div>
        ) : myRequests.length === 0 ? (
