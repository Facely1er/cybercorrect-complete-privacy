...
export function AboutPage() {
  ...
  const portalFeatures = [
    {
      ...
      description: 'Self-service portal for employees and job prospects to exercise their privacy rights including access, correction, and deletion requests.',
      regulations: ['ADA', 'EEOC', 'CCPA', 'GDPR']
    },
    {
      icon: <UserCheck className="h-8 w-8 text-green-600" />,
      title: 'My Privacy Duties',
      description: 'Role-specific guidance for employers, HR staff, and compliance officers on their privacy duties.',
    ...
    },
    {
      ...
      description: 'Privacy assessment and monitoring tools for third-party workplace technology vendors.',
  ...
  const stakeholderBenefits = [
    {
      role: 'Employees & Job Prospects',
      icon: <Eye className="h-6 w-6 text-amber-500" />,
      benefits: [
        'Easy access to employment records',
      ...
      <div className="max-w-4xl">
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            {brand.fullBrandName} simplifies workplace privacy compliance by providing self-service tools for stakeholders to understand their duties and exercise their data rights.
          </p>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-700 dark:text-blue-400 text-lg mb-4">
                CyberCorrect™ empowers employers and organizations to transform privacy compliance from a complex burden into a transparent, manageable process that builds trust with all stakeholders.
              </p>
              <p className="text-blue-700 dark:text-blue-400">
                We believe that privacy is a fundamental right, and our portal makes it easy for everyone—from employees and job prospects to HR and management—to understand their privacy duties and exercise their data rights with confidence.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center bg-gray-50 dark:bg-gray-900 rounded-lg border p-8">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Join organizations worldwide that trust {brand.productNameWithTM} to simplify compliance, protect employee data, and empower stakeholders to exercise their privacy rights.
          </p>
          ...
          <div className="mt-8 pt-6 border-t">
            <p className="text-sm text-muted-foreground mb-4">
              {brand.productNameWithTM} empowers employers and organizations to transform privacy compliance from a complex burden into a transparent, manageable process that builds trust with all stakeholders.
            </p>
