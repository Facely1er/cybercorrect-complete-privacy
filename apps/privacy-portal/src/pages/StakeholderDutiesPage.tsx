...
export function StakeholderDutiesPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const savedProgress = await localStorageService.getItem('duty_progress', {});
        const savedCompleted = await localStorageService.getItem('completed_duties', []);
  ...
  const updateDutyProgress = async (dutyId: string, progress: number) => {
  ...
  const stakeholderDuties = {
    employer: {
      title: 'Employer Privacy Duties',
      icon: <Shield className="h-6 w-6 text-blue-600" />,
      color: 'blue',
      description: 'Lead organizational privacy compliance and policy oversight',
      estimatedTime: '2-4 hours per week',
      duties: [
        {
          id: 'policy-oversight',
          title: 'Privacy Policy Development & Oversight',
          description: 'Create, maintain, and update comprehensive workplace privacy policies and procedures',
          ...
          actions: [
            ...
            'Research regulatory changes affecting workplace privacy',
            'Update policies to reflect current employment regulations and best practices',
            'Obtain legal review and approval from employment counsel',
            'Communicate policy updates to all employees',
            'Train HR staff on policy changes and implementation'
          ],
          regulations: ['ADA', 'EEOC', 'CCPA', 'General'],
          resources: [
            { title: 'Privacy Policy Template', type: 'template', url: '/resources/privacy-policy-template' },
            { title: 'ADA Compliance Guide', type: 'guide', url: '/resources/ada-guide' },
            { title: 'Policy Update Training', type: 'training', url: '/training/policy-updates' }
          ],
          dependencies: ['Legal review', 'HR consultation', 'Management approval']
        },
        {
          id: 'staff-training',
          title: 'Employee Privacy Training Program Management',
          description: 'Ensure all employees receive appropriate privacy training and maintain compliance awareness',
          ...
          estimatedHours: 12,
          actions: [
            'Assess current employee privacy knowledge and training needs',
            'Develop role-specific training curricula and materials',
            'Schedule and coordinate training sessions for all employees',
    ...
    'hr-employee': {
      title: 'HR & Employee Privacy Duties',
      icon: <Users className="h-6 w-6 text-green-600" />,
      color: 'green',
      description: 'Daily workplace privacy practices and employee data handling responsibilities',
      estimatedTime: '30 minutes per week',
      duties: [
        {
          id: 'data-protection',
          title: 'Employee Data Protection in Daily Activities',
          description: 'Protect employee information in all daily activities and communications',
          ...
          actions: [
            ...
            'Secure physical and digital employee records appropriately',
            'Verify identity before sharing employee information',
        ...
        },
        {
          ...
          description: 'Ensure proper consent and authorization before collecting or sharing employee data',
          ...
          estimatedHours: 2,
          actions: [
            'Verify consent status before sharing employee information',
    ...
    'employee-job-prospect': {
      title: 'Employee & Job Prospect Privacy Rights',
      icon: <GraduationCap className="h-6 w-6 text-amber-600" />,
      color: 'amber',
      description: 'Understanding and exercising your privacy rights as an employee or job applicant',
      estimatedTime: '1-2 hours initially, then as needed',
      duties: [
        {
          id: 'rights-awareness',
          title: 'Understanding Your Workplace Privacy Rights',
          description: 'Learn about your rights regarding personal and employment data as an employee or job applicant',
          ...
          estimatedHours: 2,
          actions: [
            'Learn about your ADA and EEOC rights as an employee',
            'Understand what constitutes workplace directory information',
            'Know how to inspect and review your employment records',
            'Understand the process for requesting record corrections',
            'Learn about your right to file privacy complaints',
            'Understand how to control workplace directory information disclosure'
          ],
          regulations: ['ADA', 'EEOC', 'CCPA'],
          resources: [
            { title: 'Employee Rights Guide', type: 'guide', url: '/resources/employee-rights' },
            { title: 'ADA Rights Overview', type: 'training', url: '/training/ada-rights' },
            { title: 'Data Rights Exercise Portal', type: 'tool', url: '/data-rights' }
          ],
          dependencies: ['Educational materials', 'Access to HR office', 'Privacy office support']
        },
        {
          id: 'digital-privacy',
          ...
          actions: [
            ...
            'Manage workplace app permissions and data sharing',
  ...
  const startDuty = async (dutyId: string) => {
    ...
    await updateDutyProgress(dutyId, 10); // Start with 10% progress
  };

  const markDutyComplete = async (dutyId: string) => {
    await updateDutyProgress(dutyId, 100);
    setActiveDuty(null);
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">My Privacy Duties</h1>
        <p className="text-muted-foreground">
          Understand and fulfill your workplace privacy duties. Select your role to view specific duties and compliance requirements.
        </p>
      </div>
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Everyone in a workplace has privacy duties. Select your role below to see your specific duties under ADA, EEOC, CCPA, and other applicable employment privacy regulations.
            </p>
          ...
          <div key={duty.id} className="bg-white dark:bg-gray-900 rounded-lg border shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-3">
                {!completedDuties.includes(duty.id) ? (
                  <>
                    ...
                    <Button 
                      variant="outline" 
                      size="sm"
                      onClick={async () => await updateDutyProgress(duty.id, Math.min((dutyProgress[duty.id] || 0) + 25, 100))}
                    >
                ...
                <Link to={`/training?topic=${duty.category.toLowerCase().replace(/\s+/g, '-')}`}>
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg border p-8">
        ...
        <p className="text-muted-foreground mb-6">
          Access comprehensive training materials, templates, and expert support to help you fulfill your privacy duties effectively and confidently.
        </p>
