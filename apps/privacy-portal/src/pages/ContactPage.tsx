          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 rounded-lg border p-6">
            ...
            <div className="mt-4 pt-4 border-t">
              ...
              <div className="space-y-2">
                ...
                <Link to="/how-it-works" title="Access self-paced training guides" className="block">
                  <Button variant="ghost" size="sm" className="w-full justify-start">
                    <GraduationCap className="h-4 w-4 mr-2" />
                    Self-Paced Training
                  </Button>
                </Link>
                <Link to="/faq" title="Download helpful resources and templates" className="block">
                  <Button variant="ghost" size="sm" className="w-full justify-start">
