...
const requiredEnvVars = {
  ...
  VITE_APP_URL: import.meta.env.VITE_APP_URL || (typeof window !== 'undefined' ? window.location.origin : 'https://portal.cybercorrect.com'),
...
const optionalEnvVars = {
  ...
  VITE_RATE_LIMIT_ENABLED: import.meta.env.VITE_RATE_LIMIT_ENABLED !== 'false',
  VITE_ACCESSIBILITY_TESTING: import.meta.env.VITE_ACCESSIBILITY_TESTING === 'true',
  VITE_REQUIRE_AUTH: import.meta.env.VITE_REQUIRE_AUTH === 'true',
  VITE_CUSTOM_ERROR_ENDPOINT: import.meta.env.VITE_CUSTOM_ERROR_ENDPOINT || ''
};
...
const appConfig = {
  ...
  errorReporting: {
    ...
    customEndpoint: optionalEnvVars.VITE_CUSTOM_ERROR_ENDPOINT
  },
  auth: {
    requireAuth: optionalEnvVars.VITE_REQUIRE_AUTH
  },
  rateLimiting: {
    enabled: optionalEnvVars.VITE_RATE_LIMIT_ENABLED
  },
  accessibility: {
    testing: optionalEnvVars.VITE_ACCESSIBILITY_TESTING
  }
};
