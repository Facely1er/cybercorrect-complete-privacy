...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 text-base font-medium leading-tight whitespace-normal break-words text-center min-w-0 max-w-full overflow-hidden box-border transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none ring-offset-background",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "min-h-10 py-2.5 px-5 text-base",
        sm: "min-h-9 py-2 px-3.5 rounded-md text-sm",
        lg: "min-h-11 py-3 px-9 rounded-md text-base",
        xl: "min-h-12 py-3 px-12 rounded-md text-lg",
