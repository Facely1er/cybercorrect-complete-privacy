...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await login(email);
      navigate('/app');
      toast.success('Login successful', 'Welcome to CyberCorrect Privacy Platform');
    } catch (error) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-md p-8 space-y-8 bg-card rounded-xl shadow-lg dark:shadow-none dark:border dark:border-muted animate-in fade-in">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-foreground">CyberCorrect Privacy Platform</h2>
