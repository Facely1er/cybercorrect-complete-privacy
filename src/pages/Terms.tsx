        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-semibold mb-4 flex items-center">
                ...
                1.3 Eligibility and Account Requirements
              </h2>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.4.3 Data Residency</h3>
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-semibold mb-4 flex items-center">
                <FileText className="h-6 w-6 text-primary mr-2" />
                1.5 License Grant and Restrictions
              </h2>
              
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium mb-2">1.5.1 License to Use Services</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.5.2 License Restrictions</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.5.3 Open-Source Components</h3>
                  <p className="text-muted-foreground text-sm">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.6.2 User Data License to ERMITS</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.6.4 Prohibited Data</h3>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium mb-2">1.7.1 ERMITS Intellectual Property</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.7.2 Trademarks</h3>
                  <p className="text-muted-foreground text-sm">
                    TechnoSoluce™, CyberCertitude™, VendorSoluce™, CyberCorrect™, CyberCaution™, and all associated logos and branding are trademarks of ERMITS LLC. You may not use these trademarks without ERMITS' prior written consent.
                  </p>
                </div>

                <div>
                  <h3 className="text-lg font-medium mb-2">1.7.3 User-Generated Reports and Outputs</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.7.4 Feedback</h3>
                  <p className="text-muted-foreground text-sm">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium mb-2">1.8.1 Third-Party Services</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.8.2 Third-Party Terms</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.8.3 Data Sharing with Third Parties</h3>
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-semibold mb-4 flex items-center">
                ...
                1.9 Beta Products and Services
              </h2>
              
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium mb-2">1.9.1 Beta Designation</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.9.2 Beta Terms</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.9.3 Beta Feedback</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.9.4 Beta Data</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.9.5 Beta Graduation</h3>
                  <p className="text-muted-foreground text-sm">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.10.2 Compliance Representations</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.10.4 Incident Reporting</h3>
                  <p className="text-muted-foreground text-sm">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.11.3 Harmful Content</h3>
                  <ul className="list-disc ml-6 space-y-1 text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.11.4 Abuse and Misuse</h3>
                  <ul className="list-disc ml-6 space-y-1 text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.11.5 Competitive Use</h3>
                  <ul className="list-disc ml-6 space-y-1 text-muted-foreground text-sm">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium mb-2">1.12.1 Pricing and Billing</h3>
                  <ul className="list-disc ml-6 space-y-1 text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.12.2 Payment Processing</h3>
                  <ul className="list-disc ml-6 space-y-1 text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.12.3 Subscription Terms</h3>
                  <ul className="list-disc ml-6 space-y-1 text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.12.4 Free Trials and Freemium Tiers</h3>
                  <ul className="list-disc ml-6 space-y-1 text-muted-foreground text-sm">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium mb-2">1.13.1 Term</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.13.2 Termination by You</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.13.3 Termination by ERMITS</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.13.4 Effect of Termination</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.13.5 Data Retention After Termination</h3>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.14.2 Disclaimer of Warranties</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.14.4 Results Disclaimer</h3>
                  <p className="text-muted-foreground text-sm mb-2">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.14.5 Privacy-First Architecture Limitations</h3>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium mb-2">1.15.1 Exclusion of Consequential Damages</h3>
                  <p className="text-muted-foreground text-sm mb-2 font-semibold">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.15.3 Liability Allocation</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.15.4 Exceptions</h3>
                  <p className="text-muted-foreground text-sm mb-2">The limitations in this section do not apply to:</p>
                  <ul className="list-disc ml-6 space-y-1 text-muted-foreground text-sm">
                    <li>ERMITS' indemnification obligations under Section 1.16.2</li>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.15.5 Basis of the Bargain</h3>
                  <p className="text-muted-foreground text-sm">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium mb-2">1.16.1 User Indemnification</h3>
                  <p className="text-muted-foreground text-sm mb-2">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.16.2 ERMITS Indemnification</h3>
                  <p className="text-muted-foreground text-sm mb-2">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.16.3 Exclusive Remedy</h3>
                  <p className="text-muted-foreground text-sm">
                    Section 1.16.2 states ERMITS' sole obligation and your exclusive remedy for intellectual property infringement claims.
                  </p>
                </div>

                <div>
                  <h3 className="text-lg font-medium mb-2">1.16.4 Indemnification Process</h3>
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-semibold mb-4 flex items-center">
                <Shield className="h-6 w-6 text-primary mr-2" />
                1.18 Service Level Commitments
              </h2>
              
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium mb-2">1.18.1 Uptime Commitment</h3>
                  <p className="text-muted-foreground text-sm mb-2">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.18.2 Scheduled Maintenance</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.18.3 SLA Credits</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.18.4 Beta Product Exclusions</h3>
                  <p className="text-muted-foreground text-sm">
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-semibold mb-4 flex items-center">
                <FileText className="h-6 w-6 text-primary mr-2" />
                1.19 Modifications to Services and Terms
              </h2>
              
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium mb-2">1.19.1 Service Modifications</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.19.2 Terms Modifications</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.19.3 Non-Material Changes</h3>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.20.2 Jurisdiction and Venue</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.20.4 Opt-Out of Arbitration</h3>
                  <p className="text-muted-foreground text-sm">
                    You may opt out of the arbitration provision by sending written notice to ERMITS at contact@ermits.com within 30 days of first accepting these Terms. The notice must include your name, address, and a clear statement that you wish to opt out of arbitration. If you opt out, disputes will be resolved in court pursuant to Section 1.20.2.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium mb-2">1.21.1 Entire Agreement</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.21.2 Severability</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.21.3 Waiver</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.21.4 Assignment</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.21.5 No Third-Party Beneficiaries</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.21.6 Notices</h3>
                  ...
                  <ul className="list-disc ml-6 space-y-1 text-muted-foreground text-sm">
                    ...
                    <li>When sent by email to contact@ermits.com (for notices to ERMITS)</li>
                    <li>When sent by email to your registered email address (for notices to you)</li>
                  </ul>
                </div>

                <div>
                  <h3 className="text-lg font-medium mb-2">1.21.7 Export Controls</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.21.8 U.S. Government Rights</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.21.9 Independent Contractors</h3>
                  <p className="text-muted-foreground text-sm">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-2">1.21.10 Survival</h3>
                  <p className="text-muted-foreground text-sm">
