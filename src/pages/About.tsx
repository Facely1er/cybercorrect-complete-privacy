          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-muted/30 rounded-lg p-8 text-center">
              ...
              <p className="text-lg text-foreground">
                To simplify privacy compliance through innovative technology and expert guidance, enabling organizations to protect personal data and meet global privacy regulatory requirements including GDPR, CCPA, and beyond.
              </p>
            </div>
          </div>
        </div>
